---
description: "[PLAN] Implements code against an epic's acceptance criteria. Does not deploy or mutate infrastructure."
mode: "all"
permission: {"edit":"deny","bash":{"*":"allow","git push*":"deny","kubectl *":"deny","helm *":"deny","argocd *":"deny","systemctl *":"deny","gh pr merge*":"deny","git merge*":"deny","helm*":"deny","argocd*":"deny","kubectl*":"deny","systemctl*":"deny","rm*":"deny","docker*":"deny"},"webfetch":"allow"}
---
