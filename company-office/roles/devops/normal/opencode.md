...
mode: "all"
permission: {"edit":"allow","bash":{"*":"allow","kubectl apply*":"deny","kubectl patch*":"deny","kubectl delete*":"deny","kubectl scale*":"deny","kubectl edit*":"deny","git push*":"ask","argocd app sync*":"ask"},"webfetch":"allow"}
---
