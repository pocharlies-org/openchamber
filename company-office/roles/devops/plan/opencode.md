---
description: "[PLAN] GitOps and infrastructure changes through the repository. Never applies by hand against the cluster."
mode: "all"
permission: {"edit":"deny","bash":{"*":"allow","kubectl apply*":"deny","kubectl patch*":"deny","kubectl delete*":"deny","kubectl scale*":"deny","kubectl edit*":"deny","git push*":"deny","argocd app sync*":"ask","gh pr merge*":"deny","git merge*":"deny","helm*":"deny","argocd*":"deny","kubectl*":"deny","systemctl*":"deny","rm*":"deny","docker*":"deny"},"webfetch":"allow"}
---
