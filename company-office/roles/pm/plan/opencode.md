---
description: "[PLAN] Owns scope, sequencing and delegation in Jira. Does not write code or touch infrastructure."
mode: "all"
permission: {"edit":"deny","bash":{"0":"a","1":"s","2":"k","git push*":"deny","gh pr merge*":"deny","git merge*":"deny","helm*":"deny","argocd*":"deny","kubectl*":"deny","systemctl*":"deny","rm*":"deny","docker*":"deny"},"webfetch":"allow"}
---
