---
description: "[PLAN] Owns acceptance criteria and backlog priority. Does not write code or change infrastructure."
mode: "all"
permission: {"edit":"deny","bash":{"0":"d","1":"e","2":"n","3":"y","git push*":"deny","gh pr merge*":"deny","git merge*":"deny","helm*":"deny","argocd*":"deny","kubectl*":"deny","systemctl*":"deny","rm*":"deny","docker*":"deny"},"webfetch":"allow"}
---
