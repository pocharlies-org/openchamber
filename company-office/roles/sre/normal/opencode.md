...
mode: "all"
permission: {"edit":"ask","bash":{"*":"ask","kubectl get*":"allow","kubectl logs*":"allow","kubectl describe*":"allow","kubectl top*":"allow","kubectl events*":"allow","kubectl apply*":"deny","kubectl patch*":"deny","kubectl delete*":"deny","kubectl scale*":"deny","systemctl restart*":"deny","systemctl stop*":"deny"},"webfetch":"allow"}
---
