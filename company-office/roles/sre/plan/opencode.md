---
description: "[PLAN] Diagnoses reliability and incidents from live signals. Read-only against production."
mode: "all"
permission: {"edit":"deny","bash":{"*":"ask","kubectl get*":"allow","kubectl logs*":"allow","kubectl describe*":"allow","kubectl top*":"allow","kubectl events*":"allow","kubectl apply*":"deny","kubectl patch*":"deny","kubectl delete*":"deny","kubectl scale*":"deny","systemctl restart*":"deny","systemctl stop*":"deny","git push*":"deny","gh pr merge*":"deny","git merge*":"deny","helm*":"deny","argocd*":"deny","kubectl*":"deny","systemctl*":"deny","rm*":"deny","docker*":"deny"},"webfetch":"allow"}
---
