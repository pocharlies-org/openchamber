...
export const dict = {
  ...
  'sessions.sidebar.project.actions.newClaudeSession': 'New Claude session',
  ...
  'chat.claudeLive.title.terminal': 'Open in a terminal',
  'chat.claudeLive.title.vscode': 'Open in VS Code',
  ...
  'chat.claudeLive.actions.takeOverAndSend': 'Take over and send',
  'chat.claudeLive.actions.openRemote': 'Open in claude.ai',
  'chat.claudeLive.actions.openVSCode': 'Open in VS Code',
  'chat.claudeLive.toast.takeOverFailed': 'Could not take the session over',
  'chat.claudeLive.toast.sendNeedsTakeOver': 'This session is open in another app that OpenChamber cannot reach',
  'chat.claudeLive.remoteLinked': 'Also open on claude.ai and in the Claude app',
  ...
  'chat.btw.closeConfirm.title': "Close this btw?",
  'chat.btw.closeConfirm.description': "It has messages. Discard deletes the side session; keep turns it into a separate session.",
  'chat.btw.closeConfirm.discard': "Discard",
  'chat.btw.closeConfirm.keep': "Keep as session",
  'chat.btw.closeConfirm.cancel': "Cancel",
