...
export const dict = {
  ...
  'companyOffice.actions.ctoDesk': 'CTO front desk',
  'companyOffice.desk.hint': 'The desk routes work. Architecture review and coordination happen in the epic sessions.',
  ...
  'companyOffice.initiatives.description': 'Epics are the workplace: each one owns a session, acceptance criteria, and delegated tickets.',
  'companyOffice.initiatives.empty': 'No Jira initiatives were returned.',
  'companyOffice.initiatives.openEpicSession': 'Open epic session',
  'companyOffice.initiatives.noEpicSession': 'No epic session yet',
  'companyOffice.initiatives.acceptanceCriteria': 'Acceptance criteria',
