...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.project.actions.newClaudeSession": "Nueva sesión de Claude",
  ...
  'chat.claudeLive.title.terminal': 'Abierta en una terminal',
  'chat.claudeLive.title.vscode': 'Abierta en VS Code',
  'chat.claudeLive.title.desktop': 'Abierta en Claude Desktop',
  'chat.claudeLive.title.other': 'Abierta en otra aplicación',
  'chat.claudeLive.description': 'Se está escribiendo allí. Para seguir aquí, OpenChamber la cierra allí y la retoma.',
  'chat.claudeLive.descriptionAttached': 'Conectada: lo que escribas aquí va a esa sesión, que responde allí y aquí.',
  'chat.claudeLive.actions.takeOver': 'Tomar el control',
  'chat.claudeLive.actions.takeOverAndSend': 'Tomar el control y enviar',
  'chat.claudeLive.actions.openRemote': 'Abrir en claude.ai',
  'chat.claudeLive.actions.openVSCode': 'Abrir en VS Code',
  'chat.claudeLive.toast.takeOverFailed': 'No se pudo tomar el control de la sesión',
  'chat.claudeLive.toast.sendNeedsTakeOver': 'Esta sesión está abierta en otra app a la que OpenChamber no llega',
  'chat.claudeLive.remoteLinked': 'También abierta en claude.ai y en la app de Claude',
  ...
  'chat.cacheTimer.expired': 'caducada',
  'chat.cacheTimer.tooltip': 'Última respuesta hace {ago} · la cache del prompt ({ttl}) caduca en {left}',
  'chat.cacheTimer.tooltipExpired': 'Última respuesta hace {ago} · la cache del prompt ({ttl}) ha caducado: el próximo turno reescribe todo el contexto',
  ...
  'chat.btw.closeConfirm.title': "¿Cerrar este btw?",
  'chat.btw.closeConfirm.description': "Tiene mensajes. Descartar borra la sesión lateral; conservar la convierte en una sesión aparte.",
  'chat.btw.closeConfirm.discard': "Descartar",
  'chat.btw.closeConfirm.keep': "Conservar como sesión",
  'chat.btw.closeConfirm.cancel': "Cancelar",
