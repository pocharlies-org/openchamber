...
export const dict = {
  ...
  'companyOffice.actions.ctoDesk': 'Bureau du CTO',
  'companyOffice.desk.hint': 'Le bureau répartit le travail. La revue d’architecture et la coordination se déroulent dans les sessions d’epic.',
  ...
  'companyOffice.initiatives.description': 'Les epics sont le lieu de travail : chacun possède sa session, ses critères d’acceptation et ses tickets délégués.',
  'companyOffice.initiatives.empty': 'Aucune initiative Jira n’a été renvoyée.',
  'companyOffice.initiatives.openEpicSession': 'Ouvrir la session d’epic',
  'companyOffice.initiatives.noEpicSession': 'Pas encore de session d’epic',
  'companyOffice.initiatives.acceptanceCriteria': 'Critères d’acceptation',
