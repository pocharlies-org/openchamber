...
export const dict = {
  ...
  'sessions.sidebar.project.actions.newClaudeSession': 'Nouvelle session Claude',
  ...
  'chat.claudeLive.title.terminal': 'Ouverte dans un terminal',
  'chat.claudeLive.title.vscode': 'Ouverte dans VS Code',
  ...
  'chat.claudeLive.actions.takeOverAndSend': 'Reprendre et envoyer',
  'chat.claudeLive.actions.openRemote': 'Ouvrir dans claude.ai',
  'chat.claudeLive.actions.openVSCode': 'Ouvrir dans VS Code',
  'chat.claudeLive.toast.takeOverFailed': 'Impossible de prendre la main sur la session',
  'chat.claudeLive.toast.sendNeedsTakeOver': 'Cette session est ouverte dans une autre app qu’OpenChamber ne peut pas joindre',
  'chat.claudeLive.remoteLinked': 'Également ouverte sur claude.ai et dans l’application Claude',
  ...
  'chat.btw.closeConfirm.title': "Fermer ce btw ?",
  'chat.btw.closeConfirm.description': "Il contient des messages. Supprimer efface la session annexe ; conserver en fait une session à part.",
  'chat.btw.closeConfirm.discard': "Supprimer",
  'chat.btw.closeConfirm.keep': "Conserver comme session",
  'chat.btw.closeConfirm.cancel': "Annuler",
