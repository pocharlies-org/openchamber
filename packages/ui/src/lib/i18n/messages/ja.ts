...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.claudeLive.title.terminal': 'ターミナルで開いています',
  'chat.claudeLive.title.vscode': 'VS Code で開いています',
  ...
  'chat.btw.closeConfirm.title': "このbtwを閉じますか？",
  'chat.btw.closeConfirm.description': "メッセージがあります。破棄するとサイドセッションは削除され、保持すると独立したセッションになります。",
  'chat.btw.closeConfirm.discard': "破棄",
  'chat.btw.closeConfirm.keep': "セッションとして保持",
  'chat.btw.closeConfirm.cancel': "キャンセル",
