...
export const dict: Record<I18nKey, string> = {
  ...
  'companyOffice.actions.ctoDesk': 'CTO 데스크',
  'companyOffice.desk.hint': '데스크는 업무를 배분하는 곳입니다. 아키텍처 검토와 조율은 에픽 세션에서 진행합니다.',
  ...
  'companyOffice.initiatives.description': '에픽이 작업 공간입니다. 각 에픽은 자체 세션, 완료 조건, 위임된 티켓을 가집니다.',
  'companyOffice.initiatives.empty': 'Jira에서 반환된 이니셔티브가 없습니다.',
  'companyOffice.initiatives.openEpicSession': '에픽 세션 열기',
  'companyOffice.initiatives.noEpicSession': '아직 에픽 세션이 없습니다',
  'companyOffice.initiatives.acceptanceCriteria': '완료 조건',
