...
export const dict: Record<I18nKey, string> = {
  ...
  'companyOffice.actions.ctoDesk': 'Recepcja CTO',
  'companyOffice.desk.hint': 'Recepcja rozdziela pracę. Przegląd architektury i koordynacja odbywają się w sesjach epik.',
  ...
  'companyOffice.initiatives.description': 'Epiki są miejscem pracy: każdy ma własną sesję, kryteria akceptacji i delegowane zgłoszenia.',
  'companyOffice.initiatives.empty': 'Jira nie zwróciła żadnych inicjatyw.',
  'companyOffice.initiatives.openEpicSession': 'Otwórz sesję epiku',
  'companyOffice.initiatives.noEpicSession': 'Brak sesji epiku',
  'companyOffice.initiatives.acceptanceCriteria': 'Kryteria akceptacji',
