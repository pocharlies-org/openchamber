...
export const dict: Record<I18nKey, string> = {
  ...
  'companyOffice.actions.ctoDesk': 'Recepção do CTO',
  'companyOffice.desk.hint': 'A recepção distribui o trabalho. A revisão de arquitetura e a coordenação acontecem nas sessões de épico.',
  ...
  'companyOffice.initiatives.description': 'Os épicos são o local de trabalho: cada um tem sua sessão, critérios de aceitação e tickets delegados.',
  'companyOffice.initiatives.empty': 'Nenhuma iniciativa foi retornada pelo Jira.',
  'companyOffice.initiatives.openEpicSession': 'Abrir sessão do épico',
  'companyOffice.initiatives.noEpicSession': 'Ainda sem sessão do épico',
  'companyOffice.initiatives.acceptanceCriteria': 'Critérios de aceitação',
