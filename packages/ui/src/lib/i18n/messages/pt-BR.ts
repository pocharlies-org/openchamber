...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.project.actions.newClaudeSession": "Nova sessão do Claude",
  ...
  'chat.claudeLive.title.terminal': 'Aberta em um terminal',
  'chat.claudeLive.title.vscode': 'Aberta no VS Code',
  'chat.claudeLive.title.desktop': 'Aberta no Claude Desktop',
  'chat.claudeLive.title.other': 'Aberta em outro aplicativo',
  'chat.claudeLive.description': 'Ela está sendo escrita lá. Para continuar aqui, o OpenChamber a fecha lá e a retoma.',
  'chat.claudeLive.descriptionAttached': 'Conectada: o que você escrever aqui vai para essa sessão, que responde lá e aqui.',
  ...
  'chat.btw.closeConfirm.title': "Fechar este btw?",
  'chat.btw.closeConfirm.description': "Ele tem mensagens. Descartar apaga a sessão lateral; manter a transforma em uma sessão separada.",
  'chat.btw.closeConfirm.discard': "Descartar",
  'chat.btw.closeConfirm.keep': "Manter como sessão",
