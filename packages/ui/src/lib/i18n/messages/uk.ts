...
export const dict: Record<I18nKey, string> = {
  ...
  'companyOffice.actions.ctoDesk': 'Приймальня CTO',
  'companyOffice.desk.hint': 'Приймальня розподіляє роботу. Огляд архітектури та координація відбуваються в сесіях епіків.',
  ...
  'companyOffice.initiatives.description': 'Епіки — це місце роботи: кожен має власну сесію, критерії приймання та делеговані завдання.',
  'companyOffice.initiatives.empty': 'Jira не повернула жодної ініціативи.',
  'companyOffice.initiatives.openEpicSession': 'Відкрити сесію епіка',
  'companyOffice.initiatives.noEpicSession': 'Сесії епіка ще немає',
  'companyOffice.initiatives.acceptanceCriteria': 'Критерії приймання',
