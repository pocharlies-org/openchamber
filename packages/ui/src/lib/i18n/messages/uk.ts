...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.claudeLive.title.terminal': 'Відкрито в терміналі',
  'chat.claudeLive.title.vscode': 'Відкрито у VS Code',
  'chat.claudeLive.title.desktop': 'Відкрито в Claude Desktop',
  'chat.claudeLive.title.other': 'Відкрито в іншому застосунку',
  'chat.claudeLive.description': 'Там зараз іде запис. Щоб продовжити тут, OpenChamber закриє її там і відновить.',
  'chat.claudeLive.descriptionAttached': 'Підключено: те, що ви напишете тут, піде в ту сесію, і вона відповість там і тут.',
  'chat.claudeLive.actions.takeOver': 'Перейняти керування',
  'chat.claudeLive.actions.takeOverAndSend': 'Перехопити й надіслати',
  'chat.claudeLive.actions.openRemote': 'Відкрити в claude.ai',
  'chat.claudeLive.actions.openVSCode': 'Відкрити у VS Code',
  'chat.claudeLive.toast.takeOverFailed': 'Не вдалося перейняти сесію',
  'chat.claudeLive.toast.sendNeedsTakeOver': 'Ця сесія відкрита в іншому застосунку, до якого OpenChamber не має доступу',
  'chat.claudeLive.remoteLinked': 'Також відкрито на claude.ai та в застосунку Claude',
  ...
  'chat.btw.closeConfirm.title': "Закрити цей btw?",
  'chat.btw.closeConfirm.description': "У ньому є повідомлення. Відхилити — видаляє бічну сесію; зберегти — робить її окремою сесією.",
  'chat.btw.closeConfirm.discard': "Відхилити",
  'chat.btw.closeConfirm.keep': "Зберегти як сесію",
  'chat.btw.closeConfirm.cancel': "Скасувати",
