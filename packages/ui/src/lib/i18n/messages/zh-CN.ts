...
export const dict: Record<I18nKey, string> = {
  ...
  'companyOffice.desk.hint': '前台负责分派工作。架构评审与协调在史诗会话中进行。',
  ...
  'companyOffice.initiatives.description': '史诗是工作场所：每个史诗都有自己的会话、验收标准和已委派的工单。',
  'companyOffice.initiatives.empty': '未返回任何 Jira 计划。',
  'companyOffice.initiatives.openEpicSession': '打开史诗会话',
  'companyOffice.initiatives.noEpicSession': '尚无史诗会话',
  'companyOffice.initiatives.acceptanceCriteria': '验收标准',
