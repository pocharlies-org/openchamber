...
export const dict: Record<I18nKey, string> = {
  ...
  'companyOffice.actions.ctoDesk': 'CTO 前台',
  'companyOffice.desk.hint': '前台負責分派工作。架構審查與協調在史詩工作階段中進行。',
  ...
  'companyOffice.initiatives.description': '史詩是工作場所：每個史詩都有自己的工作階段、驗收標準和已委派的議題。',
  'companyOffice.initiatives.empty': '未傳回任何 Jira 計畫。',
  'companyOffice.initiatives.openEpicSession': '開啟史詩工作階段',
  'companyOffice.initiatives.noEpicSession': '尚無史詩工作階段',
  'companyOffice.initiatives.acceptanceCriteria': '驗收標準',
