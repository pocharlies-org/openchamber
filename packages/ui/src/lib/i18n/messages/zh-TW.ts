...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.project.actions.newClaudeSession': '新增 Claude 會話',
  ...
  'chat.claudeLive.title.terminal': '已在終端機中開啟',
  'chat.claudeLive.title.vscode': '已在 VS Code 中開啟',
  'chat.claudeLive.title.desktop': '已在 Claude Desktop 中開啟',
  'chat.claudeLive.title.other': '已在其他應用程式中開啟',
  'chat.claudeLive.description': '那邊正在寫入。要在這裡繼續，OpenChamber 會先在那邊關閉它，再在這裡恢復。',
  'chat.claudeLive.descriptionAttached': '已連線：你在這裡輸入的內容會送到那個工作階段，它會在那邊和這裡同時回覆。',
  ...
  'chat.btw.closeConfirm.title': "關閉此 btw？",
  'chat.btw.closeConfirm.description': "其中有訊息。捨棄會刪除旁路工作階段；保留會將其變為獨立工作階段。",
  'chat.btw.closeConfirm.discard': "捨棄",
  'chat.btw.closeConfirm.keep': "保留為工作階段",
  'chat.btw.closeConfirm.cancel': "取消",
